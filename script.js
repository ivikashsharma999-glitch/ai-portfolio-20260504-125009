document.addEventListener('DOMContentLoaded', () => {
    ...
    document.addEventListener('mouseenter', () => cursorGlow.style.opacity = htmlEl.getAttribute('data-theme') === 'light' ? '0.2' : '0.15');

    /* 3. Typed.js */
    if (document.querySelector('.typed-text')) {
        new Typed('.typed-text', {
            strings: ['AI Excellence.', 'Intelligent Systems.', 'Future Innovations.'],
            typeSpeed: 50,
            backSpeed: 30,
            backDelay: 2000,
            loop: true
    ...
    const updateParticlesColor = (theme) => {
        const color = theme === 'light' ? '#059669' : '#10b981';
        initParticles(color);
    };
